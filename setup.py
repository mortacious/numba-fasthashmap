...
version = import_module_from_path('numba_fasthashmap/_version.py').__version__

setup(
    name="numba-fasthashmap",
    version=version,
    author="Felix Igelbrink",
    author_email="felix.igelbrink@uni-osnabrueck.de",
    description="A very fast custom hash map implementation for numba.",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/mortacious/numba-fasthashmap",
    project_urls={
        "Bug Tracker": "https://github.com/mortacious/numba-fasthashmap/issues",
    },
